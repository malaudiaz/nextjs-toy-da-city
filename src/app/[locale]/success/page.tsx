  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
      ...
      <p className="text-lg text-gray-600 mb-2">
        Tu pedido se ha procesado correctamente. Su pago se ha enviado a Stripe, y se ha registrado en nuestra base de datos. Debe cerrar o anular el pedido en tu historial de compras, dentro de tu perfil, en caso de no hacerlo pasadas las 72 horas entederemos que todo es correcto y procederemos a hacerlo de forma automática transfiriendo el pago al vendedor.
      </p>
